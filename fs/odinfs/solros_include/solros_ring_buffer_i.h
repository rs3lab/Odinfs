...
#define RING_BUFFER_DMA_OP_THRESHOLD  (16 * 1024) /* xeon phi */
#else
 ...
 */
int  _ring_buffer_init_nap_time(struct solros_ring_buffer_t *rb, char *mutex_name, char *cv_name);

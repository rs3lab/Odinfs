...
extern int pmfs_xip_mem_protect(struct super_block *sb, void *vaddr,
...
static inline void __pmfs_memunlock_range(void *p, unsigned long len)
{
	/*
...
static inline void __pmfs_memlock_range(void *p, unsigned long len)
{
